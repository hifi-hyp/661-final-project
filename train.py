...
from regularization import mixup_data, Cutout, Rotation
...
# if args.regularization == "rotate":
#     train_data = RotationDataset(train_data, train_mode=True)
#     test_data = RotationDataset(test_data, train_mode=False)
...
for i in range(0, EPOCHS):
    ...
    for batch_idx, (inputs, targets) in enumerate(train_loader):
        ...
        elif args.regularization == "mixup":
            inputs, targets = inputs.to(device), targets.to(device)
        ...
        elif args.regularization == "rotate":
            # print(inputs.shape)
